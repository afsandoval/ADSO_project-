"""
Django settings for ADSO_project project.
...
SECRET_KEY = 'django-insecure-xy=g#@7b$-k_b7z65in2r0qqu-tboi7)+y_f24wsh+%=yy61yi'
...
ROOT_URLCONF = 'ADSO_project.urls'
...
WSGI_APPLICATION = 'ADSO_project.wsgi.application'
